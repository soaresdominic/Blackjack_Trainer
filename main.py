...
top_row = "     2 3 4 5 6 7 8 9 10 A"
info = {
    "8A": "8,A  s s s s s s s s s  s",
    "7A": "7,A  s d d d d s s h h  h",
    "6A": "6,A  h d d d d h h h h  h",
    "5A": "5,A  h h d d d h h h h  h",
    "4A": "4,A  h h d d d h h h h  h",
    "3A": "3,A  h h h d d h h h h  h",
    "2A": "2,A  h h h d d h h h h  h",
    "AA": "A,A  p p p p p p p p p  p",
    "8":  " 8   h h h h h h h h h  h",
    "9":  " 9   h d d d d h h h h  h",
    "10": " 10  d d d d d d d d h  h",
    "11": " 11  d d d d d d d d d  h",
    "12": " 12  h h s s s h h h h  h",
    "13": " 13  s s s s s h h h h  h",
    "14": " 14  s s s s s h h h h  h",
    "15": " 15  s s s s s h h h h  h",
    "16": " 16  s s s s s h h h h  h",
    "17": " 17  s s s s s s s s s  s",
    "22": "2,2  h h p p p p h h h  h",
    "33": "3,3  h h p p p p h h h  h",
    "44": "4,4  h h h h h h h h h  h",
    "55": "5,5  d d d d d d d d h  h",
    "66": "6,6  h p p p p h h h h  h",
    "77": "7,7  p p p p p p h h h  h",
    "88": "8,8  p p p p p p p p p  p",
    "99":   "9,9  p p p p p s p p s  s",
    "1010": "1010 s s s s s s s s s  s",
}
...
while not all_correct:
    ...
    while True:
        ...
        if guess in ['s', 'h', 'd', 'p']:
            ...
            print(guessed_incorrectly)
    
    end_time = datetime.now()
    time_diff = end_time - start_time
    elapsed_seconds = time_diff.total_seconds()

    if elapsed_seconds >= 6 and guess == answer:
        ...
        # Now print the info for this dealt combo
        print(top_row)
        key_match = cards[0] + cards[1]
        if key_match in info:
            print(info[key_match])
        else:
            print(info[str(int(cards[0]) + int(cards[1]))])
        cont = input()
